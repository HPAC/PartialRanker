...
function write_algorithm0_to_eventlog(io, id, stamps)
    write( io, string(id, ";", "gemm_1.08e+05;", "1.08e+05;", "tmp3 = (C D);", "gemm!('N', 'N', 1.0, ml2, ml3, 0.0, ml4);", string(stamps[1]), ";", string(stamps[2]), '
'  ))
    write( io, string(id, ";", "gemm_1.08e+05;", "1.08e+05;", "tmp1 = (A B);", "gemm!('N', 'N', 1.0, ml0, ml1, 0.0, ml5);", string(stamps[2]), ";", string(stamps[3]), '
'  ))
    write( io, string(id, ";", "gemm_1.08e+05;", "1.08e+05;", "tmp6 = (tmp1 tmp3);", "gemm!('N', 'N', 1.0, ml5, ml4, 0.0, ml6);", string(stamps[3]), ";", string(stamps[4]), '
'  ))
end